		...
		<el-container>
			...
			<el-header class="navbar-wrapper">
				<el-menu :default-active="activeIndex" class="el-menu" mode="horizontal" :ellipsis="false"
					...
					<el-menu-item index="/resume" class="min_hide">职位推荐</el-menu-item>
					<el-menu-item index="/job" class="min_hide">找工作</el-menu-item>
					<el-menu-item index="/company" class="min_hide">找公司</el-menu-item>
					<el-menu-item index="/mine" class="min_hide" @click="gomine">个人空间</el-menu-item>
					<el-menu-item index="/enterprise/home" class="min_hide">我要招人</el-menu-item>
					<!-- 登录 -->
					<el-menu-item index="/userLogin" v-if="!Islogin"><el-button>学生登录</el-button></el-menu-item>
					<el-menu-item v-if="Islogin" class="min_hide"><el-dropdown>
							...
							<template #dropdown>
								<el-dropdown-menu>
									...
									<el-dropdown-item
										divided><strong>手机号:</strong>{{ userinfo.phone }}</el-dropdown-item>
			...
			<div class="phone-tabbar">
				<el-menu :default-active="activeIndex" class="el-menu" mode="horizontal" :ellipsis="false"
					:router="true">
					<el-menu-item index="/">
						<div class="phone-tabbar-item"><el-icon>
								<House />
							</el-icon>
							<div>首页</div>
						</div>
