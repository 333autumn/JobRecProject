		...
		<section id="formHolder">
			...
			<div class="row">
				...
				<div class="col-sm-6 brand">
					<a href="#" class="logo">求职者端<span>.</span></a>
				...
				<div class="col-sm-6 form">
					...
					<div :class="{ 'login form-peice switched': IsActive, 'login form-peice': !IsActive }">
						...
						<el-form ref="ForegetruleFormRef" :model="ForegetruleForm" :rules="Foregetrules"
							label-width="80px " :size="formSize" status-icon :label-position="labelPosition"
							v-if="isForget">
							...
							<el-form-item label="重复密码" prop="checkpassword">
								<el-input v-model="ForegetruleForm.checkpassword" autocomplete type="password"
									clearable />
							</el-form-item>
							<el-form-item label="验证码" prop="code" class="code">
					...
					<div :class="{ 'signup form-peice switched': !IsActive, 'signup form-peice': IsActive }">
						<el-form ref="SignupruleFormRef" :model="SignupruleForm" :rules="Signuprules"
							label-width="80px " :size="formSize" status-icon :label-position="labelPosition">
							<el-form-item label="邮箱" prop="email">
							...
							<el-form-item label="重复密码" prop="checkpassword">
								<el-input v-model="SignupruleForm.checkpassword" autocomplete type="password"
									clearable />
							</el-form-item>
							...
							<el-form-item label="验证码" prop="code" class="code">
								...
								<el-button style="margin-left: 20px; width: 80px !important;"
									@click="sendcode(SignupruleForm.email)">{{
                                    code_status }}</el-button>
							</el-form-item>
							<el-checkbox v-model="isRemember" label="记住密码" />
