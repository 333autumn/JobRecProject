		...
		<div class="info">
			<div class="baseinfo">
				<div style="    display: flex;align-items: center;">
					...
					<div style="">
						<el-tooltip class="box-item" effect="dark" :content="companyinfo.companyname"
							placement="bottom">
		...
		methods: {
			...
			async getjobs() {
				...
				if (this.page <= this.maxpage && this.companyinfo.companynumber) {
					...
					let response = await this.$http
						.get(this.$api.jobs +
							`?companynumber=${this.companyinfo.companynumber}&ordering=-publishtime&page=${this.page}`)
						.then(response => {
