...
class zhilian:
    ...
    def get_inter(self):
        f = open(r'D:\xd_dataset\processed_xdu_dataset\xdu_dataset_action_1w.csv', 'r', encoding='utf-8')
        f_target = open('xdu.inter', 'w', encoding='utf-8')
        f.readline()
    ...
    def get_user_item(self):
        u_index = [0, 2, 8]
        f = open(r'D:\xd_dataset\processed_xdu_dataset\xdu_dataset_user_1w.csv', 'r', encoding='utf-8')
        f_user = open('xdu.user', 'w', encoding='utf-8')
    ...
    def get_docs(self):
        u_doc_index = [3, 4, 5, 6, 7, 9, 10, 11, 12]
        f = open(r'D:\xd_dataset\processed_xdu_dataset\xdu_dataset_user_1w.csv', 'r', encoding='utf-8')
        f.readline()
        f_udoc = open('xdu.udoc', 'w', encoding='utf-8')
        ...
        j_doc_index = [1, 2, 3, 4, 5]
        f = open(r'D:\xd_dataset\processed_xdu_dataset\xdu_dataset_job.csv', 'r', encoding='utf-8')
        f.readline()
        f_idoc = open('xdu.idoc', 'w', encoding='utf-8')
