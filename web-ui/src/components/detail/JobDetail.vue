		...
		<div class="info">
			<div class="baseinfo">
				<el-tooltip class="box-item" effect="dark" :content="jobinfo.name" placement="bottom">
					<h1 class="name">{{ jobinfo.name.length <= 9 ? jobinfo.name : jobinfo.name.slice(0, 9) + '...' }}
					</h1>
				</el-tooltip>
				...
				<p style="font-size: 15px">
					...
					<span v-if="jobinfo.workingexp" style="margin-right: 15px;"><el-icon
			...
			<div class="tag">
				...
				<div class="btn">
					...
					<el-button type="warning" v-if="!iscollected" @click="Collected(jobinfo.number)"><el-icon
							style="vertical-align: middle;">
							<StarFilled />
						</el-icon>收藏</el-button>
					<el-button type="warning" v-if="iscollected" @click="removeCollected(jobinfo.number)"><el-icon
							style="color: yellow;vertical-align: middle;">
							<StarFilled />
			...
			<div class="job-detail-section">
				...
				<div style="margin-top: 20px;">
					...
					<template v-for="tag2 in jobinfo.welfaretaglist.split('/')" v-if="jobinfo.welfaretaglist">
						<el-tag class="ml-2" size="large"
							style="margin-right: 15px;margin-top: 15px;">{{ tag2 }}</el-tag>
					</template>
				</div>
				...
				<div style="margin-top: 20px;">
					<template v-for="tag1 in jobinfo.skilllabel.split('/')" v-if="jobinfo.skilllabel">
						<el-tag class="ml-2" size="large"
							style="margin-right: 15px;margin-top: 15px;">{{ tag1 }}</el-tag>
					</template>
				</div>
					...
					<div class="simlaryjob">
						...
						<div class="simlarycompanyinfo">
							<div>
								...
								<el-tooltip class="box-item" effect="dark" :content="job.companyname"
									placement="bottom">
